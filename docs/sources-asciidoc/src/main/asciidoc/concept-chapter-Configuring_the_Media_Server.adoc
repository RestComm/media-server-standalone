...
By editing the `MS_HOME/conf/media-server-extra.yml` file users can override the configuration parameters they need without having to go through every aspect of the Media Server configuration.
...
[[_ctms_configuring_the_media_server_running_session]]
