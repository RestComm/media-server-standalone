...
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.ListeningScheduledExecutorServiceProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.media.MgcpCallManagerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.AsyncMgcpChannelProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.DynamicMgcpPackageManagerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.GlobalMgcpEventProviderProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.GlobalMgcpTransactionManagerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.LocalNetworkGuardProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MediaGroupProviderProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.Mgcp2ControllerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MgcpChannelInboundHandlerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MgcpChannelInitializerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MgcpCommandProviderProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MgcpConnectionProviderProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MgcpEndpointInstallerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MgcpEndpointManagerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MgcpNetworkManagerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MgcpSignalProviderProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.MgcpTransactionNumberspaceProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.RtpEventProviderProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.mgcp.SubMgcpTransactionManagerProviderProvider;
