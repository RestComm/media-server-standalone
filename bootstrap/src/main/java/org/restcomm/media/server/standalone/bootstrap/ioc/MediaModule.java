...
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.DspProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.media.AudioPlayerProviderProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.media.AudioRecorderProviderProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.media.ChannelsManagerProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.media.DtmfDetectorProviderProvider;
import org.restcomm.media.server.standalone.bootstrap.ioc.provider.media.MediaChannelProviderProvider;
